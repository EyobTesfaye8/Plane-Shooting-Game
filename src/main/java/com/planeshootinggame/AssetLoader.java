...
public class AssetLoader {
    ...
    // public Image playerIMG =            new Image(getClass().getResource("/Assets/Image/player/
    ...
    public AssetLoader(){
        ...
        for(int i = 1; i<=4; i++){
            playerIMGS[i-1] = new Image(
                getClass().getResource("/Assets/Image/player/playerMove/playerMove"+i+".png").toExternalForm());
        }
    }
}
